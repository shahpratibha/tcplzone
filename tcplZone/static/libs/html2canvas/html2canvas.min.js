...
!(function(A, e) {
    ...
    var f = function(A, e) {
      ...
      g = function() {
        ...
        for (var B = [], r = -1, n = ""; ++r < t; ) {
          ...
          s <= 65535
            ? B.push(s)
            : ((s -= 65536), B.push(55296 + (s >> 10), s % 1024 + 56320)), (r +
            1 ===
            t ||
            16384 < B.length) &&
  ...
  var o = (
    (i.prototype.get = function(A) {
      ...
      if (0 <= A) {
        ...
        if (A <= 65535)
          return (e = this.index[2048 + ((A - 55296) >> 5)]), this.data[
            (e = (e << 2) + (31 & A))
          ];
        if (A < this.highStart)
          return (e = this.index[(e = 2080 + (A >> 11))]), (e = this.index[
            (e += (A >> 5) & 63)
    ...
    j = (
      (F = (function(A) {
        ...
        for (
          ...
          (e = c[A.charCodeAt(Q)]), (t = c[A.charCodeAt(Q + 1)]), (B =
            c[A.charCodeAt(Q + 2)]), (r = c[A.charCodeAt(Q + 3)]), (i[o++] =
            (e << 2) | (t >> 4)), (i[o++] = ((15 & t) << 4) | (B >> 2)), (i[
            o++
          ] =
            ((3 & B) << 6) | (63 & r));
        return n;
    ...
    GA = (
      ...
      (OA.prototype.consumeUrlToken = function() {
        ...
        for (;;) {
          ...
          if (cA(B))
            return this.consumeWhiteSpace(), -1 === this.peekCodePoint(0) ||
  ...
  var VA = (
    ...
    (kA.prototype.consumeSimpleBlock = function(A) {
      for (var e = { type: A, values: [] }, t = this.consumeToken(); ; ) {
        ...
        this.reconsumeToken(t), e.values.push(
  ...
  var re = function(A, e) {
    ...
    ae = function(A, e) {
      ...
      if (5 === e.type) {
        ...
        if (6 === e.value.length) {
          (B = e.value.substring(0, 2)), (r = e.value.substring(
            2,
            4
  ...
  function Ue(A, e, t) {
    return t < 0 &&
      (t += 1), 1 <= t && --t, t < 1 / 6 ? (e - A) * t * 6 + A : t < 0.5 ? e : t < 2 / 3 ? 6 * (e - A) * (2 / 3 - t) + A : A;
  }
  function Ce(A, e) {
  ...
  var fe = function(A, e) {
      ...
      (n = B <= 0.5 ? B * (1 + A) : B + A - B * A), (e = 2 * B - n), (A = Ue(
        e,
        n,
        t + 1 / 3
      )), (B = Ue(e, n, t)), (t = Ue(e, n, t - 1 / 3));
  ...
  function ke(A, e) {
    return PA(A) && "normal" === A.value
      ? 1.2 * e
      : 17 === A.type ? e * A.number : qA(A) ? ie(A, e) : e;
  }
  var Re,
    Ne,
    Pe = {
  ...
  for (
    var oB = function(A, e) {
      ...
      aB = function(A, e) {
        (this.context = A), (this.textNodes = []), (this.elements = []), (this.flags = 0), cB(
          e,
          3
        ), (this.styles = new nB(A, window.getComputedStyle(e, null))), Or(e) &&
          (
  ...
  var EB,
    ...
    MB = (
      (yB = (function(A) {
        ...
        for (
          ...
          (e = wB[A.charCodeAt(Q)]), (t = wB[A.charCodeAt(Q + 1)]), (B =
            wB[A.charCodeAt(Q + 2)]), (r = wB[A.charCodeAt(Q + 3)]), (i[o++] =
            (e << 2) | (t >> 4)), (i[o++] = ((15 & t) << 4) | (B >> 2)), (i[
            o++
          ] =
            ((3 & B) << 6) | (63 & r));
      ...
      new lB(KB[0], KB[1], KB[2], KB[3], EB, IB)
    ),
    SB = "×",
    TB = function(A, e, t, B, r) {
      ...
      return s.setAttributeNS(null, "width", A.toString()), s.setAttributeNS(
        null,
        "height",
        e.toString()
      ), n.setAttributeNS(null, "width", "100%"), n.setAttributeNS(
        null,
        "height",
        "100%"
      ), n.setAttributeNS(null, "x", t.toString()), n.setAttributeNS(
        null,
        "y",
        B.toString()
      ), n.setAttributeNS(
        ...
        var A = (function(A) {
          if (A.createRange) {
            ...
            if (e.getBoundingClientRect) {
              ...
              (t.style.height = "123px"), (t.style.display =
                "block"), A.body.appendChild(t), e.selectNode(t);
      ...
      get SUPPORT_WORD_BREAKING() {
        var A =
          ...
          (function(A) {
            ...
            (e.style.width = "50px"), (e.style.display =
              "block"), (e.style.fontSize = "12px"), (e.style.letterSpacing =
        ...
        var A =
          "function" == typeof Array.from && "function" == typeof window.fetch
            ? (function(t) {
                ...
                e.src = n;
                e = TB(B, B, 0, 0, e);
                return (r.fillStyle = "red"), r.fillRect(0, 0, B, B), GB(e)
                  .then(function(A) {
                    r.drawImage(A, 0, 0);
                    ...
                    return (A.style.backgroundImage =
                      "url(" +
                      n +
                      ")"), (A.style.height = "100px"), pB(e) ? GB(TB(B, B, 0, 0, A)) : Promise.reject(!1);
                  })
                  .then(function(A) {
                    return r.drawImage(
                      A,
    ...
    YB = function(A, e, t) {
      var r, n, s, o, i;
      (this.text = WB(e.data, t.textTransform)), (this.textBounds = (
        (r = A),
        (A = this.text),
        (s = e),
        (A = PB(A, (n = t))),
        ...
        A.forEach(function(A) {
          ...
          n.textDecorationLine.length || 0 < A.trim().length
            ...
            : OB.SUPPORT_RANGE_BOUNDS ||
              (s = s.splitText(A.length)), (i += A.length);
        }),
        o
      ));
    },
  ...
  function jB(A, e) {
    ...
    return (A.src =
      e.currentSrc ||
      e.src), (A.intrinsicWidth = e.naturalWidth), (A.intrinsicHeight = e.naturalHeight), A.context.cache.addImage(A.src), A;
  }
  var zB,
    $B = (A(Ar, (zB = aB)), Ar);
  function Ar(A, e) {
  ...
  function Br(A, e) {
    ...
    return e.setAttribute(
      "width",
      A.width + "px"
    ), e.setAttribute("height", A.height + "px"), (t.svg = "data:image/svg+xml," + encodeURIComponent(B.serializeToString(e))), (t.intrinsicWidth = e.width.baseVal.value), (t.intrinsicHeight = e.height.baseVal.value), t.context.cache.addImage(t.svg), t;
  }
  var rr,
    nr = (A(sr, (rr = aB)), sr);
  function sr(A, e) {
  ...
  function Qr(A, e) {
    ...
    return (A.start =
      e.start), (A.reversed = "boolean" == typeof e.reversed && !0 === e.reversed), A;
  }
  var cr,
  ...
  function Kr(A, e) {
    ...
    (r.src =
      e.src), (r.width = parseInt(e.width, 10) || 0), (r.height = parseInt(e.height, 10) || 0), (r.backgroundColor = r.styles.backgroundColor);
    try {
      e.contentWindow &&
        ...
        (
          ...
          (r.backgroundColor = ee(t)
            ? ee(B) ? r.styles.backgroundColor : B
            : t)
        );
    } catch (A) {}
    return r;
        ...
        : Jr(e)
          ...
          : Pr(e)
            ...
            : kr(e)
              ...
              : Rr(e)
                ? ir
                : Nr(e) ? ur : _r(e) ? dr : Zr(e) ? pr : Wr(e) ? yr : aB)(A, e);
    },
    xr = function(A, e) {
      var t = vr(A, e);
    ...
    for (var i = 0; 0 < s && i <= 4; i++) {
      ...
      0 == Q && Gt(n, 1) && "" !== o
        ...
        : 1 < Q ||
          ...
          (1 == Q && 1 < i && Gt(n, 8))
          ? (o = e[Q] + (0 < i ? t[i - 1] : "") + o)
          : 1 == Q && 0 < i && (o = t[i - 1] + o), (s = Math.floor(s / 10));
    }
    return (A < 0 ? B : "") + o;
  }
  var rn,
    ...
    wn = (
      (Un.prototype.toIFrame = function(A, B) {
        ...
        return o.open(), o.write(fn(document.doctype) + "<html></html>"), Hn(
      ...
      (Un.prototype.createElementClone = function(A) {
        ...
        if (mr(A)) return this.createStyleClone(A);
        var e = A.cloneNode(!1);
        return Yr(e) &&
          (
            Yr(A) &&
      ...
      (Un.prototype.appendChildNode = function(A, e, t) {
        (Gr(e) &&
          ...
          (this.options.copyStyles && Gr(e) && mr(e)) ||
      ...
      (Un.prototype.cloneNode = function(A, e) {
        ...
        if (B && Gr(A) && (Or(A) || Vr(A))) {
          ...
          this.referenceElement === A &&
            Or(r) &&
            (this.clonedReferenceElement = r), Xr(r) && Kn(r);
          (B = this.counters.parse(
            new iB(this.context, n)
          )), (s = this.resolvePseudoContent(A, r, s, rn.BEFORE));
          Lr(A) && (e = !0);
          for (var i, Q = (A.shadowRoot || A).firstChild; Q; Q = Q.nextSibling)
            Gr(Q) && qr(Q) && "function" == typeof Q.assignedNodes
              ? (i = Q.assignedNodes()).length &&
          ...
          return o && r.appendChild(o), this.counters.pop(B), ((n &&
            (this.options.copyStyles || Vr(A)) &&
            !Wr(A)) ||
            e) &&
            dn(n, r), (0 === A.scrollTop && 0 === A.scrollLeft) ||
            this.scrolledElements.push([r, A.scrollLeft, A.scrollTop]), (Zr(
            A
          ) ||
            _r(A)) &&
            (Zr(r) || _r(r)) &&
  ...
  ((we = rn = rn || {})[(we.BEFORE = 0)] =
    "BEFORE"), (we[(we.AFTER = 1)] = "AFTER");
  function Cn(e) {
  ...
  var ln = function(A, e) {
      ...
      return (t.className = "html2canvas-container"), (t.style.visibility =
        "hidden"), (t.style.position = "fixed"), (t.style.left =
        "-10000px"), (t.style.top = "0px"), (t.style.border =
        "0"), (t.width = e.width.toString()), (t.height = e.height.toString()), (t.scrolling =
        "no"), t.setAttribute(gn, "true"), A.body.appendChild(t), t;
    },
    un = function(A) {
    ...
    Ln = (
      ...
      (bn.setContext = function(A) {
        (bn._link = A.document.createElement("a")), (bn._origin = bn.getOrigin(
          A.location.href
        ));
      }),
  ...
  var Dn = (
            ...
            case 2:
              return this.context.logger.debug(
                ...
                new Promise(function(A, e) {
                  ...
                  (t.onload = function() {
                    return A(t);
                  }), (t.onerror = e), (On(r) || B) && (t.crossOrigin = "anonymous"), (t.src = r), !0 ===
                    t.complete &&
                    setTimeout(function() {
                      return A(t);
    ...
    (vn.prototype.proxy = function(s) {
      ...
      return new Promise(function(e, t) {
        ...
        ), "text" != B && r instanceof XMLHttpRequest && (r.responseType = B), o
  ...
  var Wn,
    Zn = function(A) {
      var e = A.styles,
        ...
        c = h[1];
      (d = []).push((B + n) / t.width), d.push((Q + o) / t.width), d.push(
        (r + c) / t.height
      ), d.push((s + i) / t.height), 1 < (f = Math.max.apply(Math, d)) &&
        (
          (B /= f),
          (r /= f),
          (n /= f),
      ...
      (this.topLeftBorderDoubleOuterBox =
        ...
        0 < B || 0 < r
          ...
          : new Rn(t.left + F / 2, t.top + C / 2)), (this.topRightBorderStroke =
        0 < B || 0 < r
        ...
        0 < B || 0 < r
          ...
          : new Rn(t.left, t.top)), (this.topRightBorderBox =
        0 < n || 0 < s
          ? $n(t.left + a, t.top, n, s, Wn.TOP_RIGHT)
          : new Rn(t.left + t.width, t.top)), (this.bottomRightBorderBox =
        0 < o || 0 < i
        ...
        0 < Q || 0 < c
          ...
          : new Rn(t.left, t.top + t.height)), (this.topLeftPaddingBox =
        0 < B || 0 < r
          ? $n(
              t.left + F,
              t.top + C,
          ...
          : new Rn(t.left + F, t.top + C)), (this.topRightPaddingBox =
        0 < n || 0 < s
          ? $n(
        ...
        0 < Q || 0 < c
          ...
          : new Rn(t.left + F, t.top + t.height - u)), (this.topLeftContentBox =
        0 < B || 0 < r
          ? $n(
              t.left + F + A,
              t.top + C + h,
          ...
          : new Rn(t.left + F + A, t.top + C + h)), (this.topRightContentBox =
        0 < n || 0 < s
          ? $n(
  ...
  ((we = Wn = Wn || {})[(we.TOP_LEFT = 0)] =
    "TOP_LEFT"), (we[(we.TOP_RIGHT = 1)] = "TOP_RIGHT"), (we[(we.BOTTOM_RIGHT = 2)] = "BOTTOM_RIGHT"), (we[(we.BOTTOM_LEFT = 3)] = "BOTTOM_LEFT");
  function _n(A) {
    return [
      A.topLeftBorderBox,
      A.topRightBorderBox,
      ...
      (ns.prototype.getEffects = function(e) {
        for (
          ...
          A || 0 !== t.container.styles.position || !t.parent
            ...
            : B.unshift.apply(B, s), (t = t.parent);
        }
  ...
  var gs = function(Q, c, a, g) {
          ...
          ? (
              ...
              A.styles.isTransformed()
                ...
                : (A.styles.isFloating()
                    ...
                    : r.nonPositionedInlineLevel).push(t),
              gs(B, t, e ? t : a, i)
            )
          : (
              (A.styles.isInlineLevel()
                ? c.inlineLevel
                : c.nonInlineLevel).push(B),
              gs(B, c, a, i)
            ), Gt(A.flags, 8) && ws(A, i);
      });
    },
    ws = function(A, e) {
      for (
        ...
        n.container instanceof nr &&
          ...
          0 !== n.container.value &&
          (t = n.container.value), (n.listValue = an(
          t,
    ...
    Us = function(A, e) {
      var t = [];
      return Yn(A) ? t.push(A.subdivide(0.5, !1)) : t.push(A), Yn(e)
        ? t.push(e.subdivide(0.5, !0))
        : t.push(e), t;
    },
    Cs = function(A, e, t, B) {
      var r = [];
      return Yn(A) ? r.push(A.subdivide(0.5, !1)) : r.push(A), Yn(t)
        ? r.push(t.subdivide(0.5, !0))
        : r.push(t), Yn(B)
        ? r.push(B.subdivide(0.5, !0).reverse())
        : r.push(B), Yn(e)
    ...
    ds = (
      (fs.prototype.parseMetrics = function(A, e) {
        ...
        (t.style.visibility =
          "hidden"), (t.style.fontFamily = A), (t.style.fontSize = e), (t.style.margin =
          "0"), (t.style.padding = "0"), (t.style.whiteSpace =
          "nowrap"), n.appendChild(t), (B.src =
          "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"), (B.width = 1), (B.height = 1), (B.style.margin =
          "0"), (B.style.padding = "0"), (B.style.verticalAlign =
          "baseline"), (r.style.fontFamily = A), (r.style.fontSize = e), (r.style.margin =
          "0"), (r.style.padding = "0"), r.appendChild(
          this._document.createTextNode(hs)
        ), t.appendChild(r), t.appendChild(B);
        e = B.offsetTop - r.offsetTop + 2;
        t.removeChild(r), t.appendChild(
          this._document.createTextNode(hs)
        ), (t.style.lineHeight = "normal"), (B.style.verticalAlign = "super");
      ...
      (fs.prototype.getMetrics = function(A, e) {
        ...
        return void 0 === this._data[t] &&
          (this._data[t] = this.parseMetrics(A, e)), this._data[t];
      }),
      fs
    );
  function fs(A) {
  ...
  var Hs,
    ...
    ps = (
      ...
      (Es.prototype.applyEffect = function(A) {
        this.ctx.save(), 2 === A.type &&
          (this.ctx.globalAlpha = A.opacity), 0 === A.type &&
          (
          ...
          (this.path(A.path), this.ctx.clip()), this._activeEffects.push(A);
      }),
      ...
      (Es.prototype.renderTextNode = function(i, Q) {
        return a(this, void 0, void 0, function() {
          var e,
            ...
            o = this;
          return H(this, function(A) {
            return (B = this.createFontStyle(
              Q
            )), (e = B[0]), (t = B[1]), (B = B[2]), (this.ctx.font = e), (this.ctx.direction = 1 === Q.direction ? "rtl" : "ltr"), (this.ctx.textAlign = "left"), (this.ctx.textBaseline = "alphabetic"), (B = this.fontMetrics.getMetrics(t, B)), (r = B.baseline), (n = B.middle), (s = Q.paintOrder), i.textBounds.forEach(
              function(t) {
                  ...
                  switch (A) {
                        ...
                        (
                          e.slice(0).reverse().forEach(function(A) {
                            (o.ctx.shadowColor = te(
                              A.color
                            )), (o.ctx.shadowOffsetX = A.offsetX.number * o.options.scale), (o.ctx.shadowOffsetY = A.offsetY.number * o.options.scale), (o.ctx.shadowBlur = A.blur.number), o.renderTextWithLetterSpacing(t, Q.letterSpacing, r);
                          }),
                          (o.ctx.shadowColor = ""),
                    ...
                    case 1:
                      Q.webkitTextStrokeWidth &&
                        ...
                        ), (o.ctx.strokeStyle = ""), (o.ctx.lineWidth = 0), (o.ctx.lineJoin = "miter");
                  }
                });
              }
            ), [2];
          ...
          return H(this, function(A) {
            switch (A.label) {
              case 0:
                this.applyEffects(
                  w.getEffects(4)
                ), (e = w.container), (t = w.curves), (B = e.styles), (r = 0), (n = e.textNodes), (A.label = 1);
              case 1:
                return r < n.length
              ...
              case 14:
                if (
                  ...
                  (i = g.add(
                    ...
                    B.letterSpacing,
                    c
                  ), this.ctx.restore(), (this.ctx.textBaseline =
      ...
      (Es.prototype.mask = function(A) {
        this.ctx.beginPath(), this.ctx.moveTo(0, 0), this.ctx.lineTo(
          this.canvas.width,
          0
        ), this.ctx.lineTo(
          this.canvas.width,
          this.canvas.height
        ), this.ctx.lineTo(0, this.canvas.height), this.ctx.lineTo(
          0,
          0
      ...
      (Es.prototype.renderRepeat = function(A, e, t, B) {
        this.path(A), (this.ctx.fillStyle = e), this.ctx.translate(
          t,
          B
      ...
      (Es.prototype.resizeImage = function(A, e, t) {
        ...
        var B = (null !== (B = this.canvas.ownerDocument) && void 0 !== B
          ? B
          : document).createElement("canvas");
        return (B.width = Math.max(1, e)), (B.height = Math.max(
          1,
          t
                              ...
                              0 < F &&
                                ...
                                (
                                  ...
                                  F !== u
                                    ? (
                                        (C =
                                          f.bounds.left + 0.5 * f.bounds.width),
                                        (l =
                                          f.bounds.top + 0.5 * f.bounds.height),
                                        (F = 1 / (u = u / F)),
                                        d.ctx.save(),
                                        d.ctx.translate(C, l),
      ...
      (Es.prototype.renderSolidBorder = function(e, t, B) {
        return a(this, void 0, void 0, function() {
          return H(this, function(A) {
            return this.path(
              ss(B, t)
            ), (this.ctx.fillStyle = te(e)), this.ctx.fill(), [2];
          });
        });
      }),
            ...
            switch (A.label) {
              ...
              case 2:
                return (e = (function(A, e) {
                  ...
                  n,
                  r
                )), this.path(e), (this.ctx.fillStyle = te(t)), this.ctx.fill(), (e = (function(
                  A,
                  e
                ) {
                  switch (e) {
        ...
        return a(this, void 0, void 0, function() {
          ...
          return H(this, function(A) {
            switch (A.label) {
              case 0:
                return (
                  this.applyEffects(c.getEffects(2)),
                ...
                A.sent(), this.ctx.restore(), e.boxShadow.slice(0).reverse().forEach(function(A) {
                  ...
                  A.inset
                    ...
                    : (
                        ...
                        Q.ctx.clip(),
                        Q.path(o)
                      ), (Q.ctx.shadowOffsetX = A.offsetX.number + s), (Q.ctx.shadowOffsetY = A.offsetY.number), (Q.ctx.shadowColor = te(A.color)), (Q.ctx.shadowBlur = A.blur.number), (Q.ctx.fillStyle = A.inset ? te(A.color) : "rgba(0,0,0,1)"), Q.ctx.fill(), Q.ctx.restore();
                }), (A.label = 2);
              case 2:
                (s = n = 0), (o = B), (A.label = 3);
              case 3:
            ...
            switch (A.label) {
              case 0:
                return this.options.backgroundColor &&
                  ...
                  ), (t = new rs((e = r), null)), (B = new Bs(t)), gs(t, B, B, (e = [])), ws(t.container, e), [4, this.renderStack(B)];
              case 1:
  ...
  var Is,
    ys = function(A) {
      return (
        A instanceof pr ||
        (A instanceof dr || (A instanceof ur && A.type !== Ur && A.type !== wr))
      );
    },
    Ks = function(A, e) {
      switch (A) {
  ...
  function vs(A, e) {
    ...
    return (A.canvas =
      ...
      document.createElement(
        "canvas"
      )), (A.ctx = A.canvas.getContext("2d")), (A.options = e), (A.canvas.width = Math.floor(e.width * e.scale)), (A.canvas.height = Math.floor(e.height * e.scale)), (A.canvas.style.width = e.width + "px"), (A.canvas.style.height = e.height + "px"), A.ctx.scale(A.options.scale, A.options.scale), A.ctx.translate(-e.x, -e.y), A.context.logger.debug("EXPERIMENTAL ForeignObject renderer initialized (" + e.width + "x" + e.height + " at " + e.x + "," + e.y + ") with scale " + e.scale), A;
  }
  var xs = function(B) {
      return new Promise(function(A, e) {
        var t = new Image();
  ...
  function Gs(A, e) {
    (this.windowBounds = e), (this.instanceName = "#" + Gs.instanceCount++), (this.logger = new Ms({ id: this.instanceName, enabled: A.logging })), (this.cache = null !== (e = A.cache) && void 0 !== e ? e : new Dn(this, A));
  }
        ...
        return H(this, function(A) {
          switch (A.label) {
            ...
            case 3:
              ...
              ), g.logger.debug("Starting DOM parsing"), (l = xr(g, w)), i === l.styles.backgroundColor && (l.styles.backgroundColor = pe.TRANSPARENT), g.logger.debug("Starting renderer for element at " + C.x + "," + C.y + " with size " + C.width + "x" + C.height), [4, new ps(g, C).render(l)];
            case 4:
              (Q = A.sent()), (A.label = 5);
            case 5:
    ...
    Vs = function(A, e, t) {
      var B = e.ownerDocument,
        ...
        t =
          "string" == typeof t
            ? Ce(A, t)
            : null === t ? pe.TRANSPARENT : 4294967295;
