...
!(function() {
  ...
  !(function(t) {
        ...
        .then(function(t) {
          e.innerHTML = t.reduce(function(t, e) {
            return (
              t +
              '<option data-id="' +
              e.osm_type.charAt(0).toUpperCase() +
              e.osm_id +
              '">' +
              e.display_name +
              "</option>"
    ...
    suggest: function(t, e) {
      var n = this;
      (this.datalist = e), this.fetchResults(t, { typeahead: !0 })
        .then(function(t) {
  ...
  var p = function(t, e, n) {
    ...
    return (e = g(e) || 0), d(n) &&
      (
        (p = !!n.leading),
        (i = (m = "maxWait" in n) ? h(g(n.maxWait) || 0, e) : i),
  ...
  (L.Control.Search = L.Control.extend({
    ...
    onAdd: function(t) {
      ...
      (o.type = "text"), o.setAttribute("list", e), L.DomEvent.on(
        o,
        "input",
        p(function(e) {
          e.target.value.length >= this.options.suggest &&
            t._geocoder.suggest(e.target.value, i);
        ...
        function(t) {
          ...
          for (var r = 0; r < o.length; r++)
            if (e.startsWith(o[r].innerText))
              return void this._geocoder.lookup(o[r].dataset.id);
          this.geocode(e);
        },
        t
      );
      ...
      (r.innerHTML =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z"/></svg>'), (r.title =
        "Search"), L.DomEvent.on(
        r,
        "click",
        function(t) {
    ...
    placeMarker: function(t, e, n) {
      if (
        (this.fire("geofound", { latlng: t, bbox: e, place: n }), this.marker)
      )
      ...
      this.options.fly
        ? e ? this.flyToBounds(e) : this.flyTo(t)
        : e ? this.fitBounds(e) : this.panTo(t);
    },
    geocode: function(t) {
      return this._geocoder.geocode(t), this;
    },
    setGeocoder: function(t, e) {
      return void 0 === e && (e = {}), (this._geocoder = new L.geo[t](
        this,
        e
      )), this;
    }
